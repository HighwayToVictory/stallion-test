...
<template>
  <div class="p-5">
    ...
    <div class="mb-5">
      <RouterLink to="/namespaces/new" type="button" class="btn btn-primary">
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="item in namespaces" v-bind:key="item['id']">
          <td class="p-3">
            {{ item['name'] }}
          </td>
          <td class="p-3">
          ...
          <td>
            <button v-on:click="deleteNamespace(item['id'])" class="btn btn-danger text-left" style="margin-right: 5px;">
            ...
            <RouterLink :to="`/namespaces/edit/${item['id']}`" class="btn btn-primary text-left">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi me-2 bi-person-x-fill" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6.146-2.854a.5.5 0 0 1 .708 0L14 6.293l1.146-1.147a.5.5 0 0 1 .708.708L14.707 7l1.147 1.146a.5.5 0 0 1-.708.708L14 7.707l-1.146 1.147a.5.5 0 0 1-.708-.708L13.293 7l-1.147-1.146a.5.5 0 0 1 0-.708z"/>
              </svg>
              Edit
