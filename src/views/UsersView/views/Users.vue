  ...
  <div class="p-5">
    ...
    <div class="row p-0 m-0 mb-3" style="grid-column-gap: 20px;">
      ...
      <div class="col bg-light rounded p-3">
        ...
        <RouterLink style="inline-size: none;: 100%;" to="/users/new" type="button" class="btn btn-primary">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="user in users" v-bind:key="user['id']">
            ...
            <td style="text-align: center;">
              <button v-on:click="deleteUser(user['id'])" class="btn btn-sm btn-danger text-left" style="margin-inline-end: 5px;">
              ...
              <RouterLink :to="'/users/edit/'+user['id']" class="btn btn-sm btn-primary text-left">
