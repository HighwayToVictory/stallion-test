...
<template>
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="height: 100vh;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <RouterLink to="/projects" class="nav-link text-white" active-class="active">
      ...
      <li>
        <RouterLink to="/instructions" class="nav-link text-white" active-class="active">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi me-2 bi-database" viewBox="0 0 16 16">
